...
2. *visualizations* - Array of visualizations. Each visualization follows the [Visualization structure](//TODO)

The *generate\_db\_entry* method must do following:
* Return entry specifying the name and summary, see below
* Return empty array or array of one or more dictionaries following the [Visualization structure](//TODO)
...
* The `"summary"` value defines the summary specific to the the particular data type. The value has to follow the [Summary structure](//TODO).
...
* `"html"` is an upcoming feature allowing the display of custom html in the visualization card.
